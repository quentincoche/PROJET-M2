...
class Fenetre(Thread):
    ...
    def display(self):
        ...
        #cadre résultat traitement
        self.display2 = tk.Canvas(self.window,width=0.2*self.Screen_x ,height=0.2*self.Screen_y , bg="yellow")
...
class camera(Thread):
    ...
    def video_tool(self):
        ...
        thread2.start()
        self.resultat_trmt = self.trmt.img020
        self.display2.create_image(0.2*self.Screen_x,0.2*self.Screen_x,image=self.resultat_trmt)
